...
public class MainExecutavel {
    ...
    public static void main(String[] args) throws IOException {
        ...
        GeradorXMLCompactado geradorXMLCompactado = new GeradorXMLCompactado(new Compactador());
        geradorXMLCompactado.geradorArquivo("arquivo aleatorio", objectMap);

        GeradorPropriedadesCriptografado propriedadesCriptografado = new GeradorPropriedadesCriptografado(new Criptografador(5));
